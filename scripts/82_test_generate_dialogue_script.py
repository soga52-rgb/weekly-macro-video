...
# -*- coding: utf-8 -*-
"""
Step 82 v8.3.2.1 - Story-only Dialogue Generator
...
11. Tom 的開場白不要先報新聞清單，也不要先下本週結論；Tom 要用主持人的方式打開問題，請 Miranda 先從本週市場價格走勢切入分析。
    開場可以類似：「Miranda，這週如果先不看新聞標題，而是先看市場價格本身，有哪些走勢最值得我們注意？它們背後反映的是什麼市場訊號？」
...
請根據下方資料，產生 Step 82 v8.3.2 Story-only Tom / Miranda 總經訪談稿。
