...
請特別整理：
1. 通膨背景：CPI / PPI / PCE / PMI價格分項 / 通膨黏性 / 消費者通膨預期。
2. 就業背景：非農、失業率、薪資、勞動市場是否仍支撐通膨或高利率。
...
- 不要把油價單週變化直接等同於整體通膨預期，除非有其他通膨資料佐證。
"""
...
{{
  ...
  "inflation_background": [
    {{
      ...
      "published_at": "",
      "why_it_matters": "",
      "signal": "support_inflation / cool_inflation / mixed / unclear",
      "url": ""
    }}
  ],
  "labor_background": [],
